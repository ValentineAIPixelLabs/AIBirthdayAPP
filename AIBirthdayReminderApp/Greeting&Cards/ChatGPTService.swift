...
""")
    ...
    func generateCreativePrompt(for contact: Contact, apiKey: String, completion: @escaping (Result<String, Error>) -> Void) {
        ...
        let systemPrompt = """
        Ты — эксперт по созданию AI-промтов для генерации поздравительных открыток в gpt-image-1. Используй информацию о человеке как источник вдохновения: не вставляй личные данные напрямую, а строй ассоциации, сценарии, аллюзии.
        ...
        Твой промт должен быть коротким (до 80 слов), описывать насыщенную мини-сцену для AI, включать:
